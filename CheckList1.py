...
layout=[
    ...
    [sh.InputText('',key='name',background_color="Sky Blue"),sh.Button('ADD',key="add",size=(6,1)),sh.CalendarButton("SELECT DATE",target="date",key="dat"),sh.InputText("",key = "date", disabled=True ,do_not_clear=False)],
    ...
    [sh.Button("DELETE",key="del"),sh.Button("Completed",size=(8,1),key="comp",)],[sh.Text("Priority:",text_color="blue",background_color="cyan"),sh.Spin([sz for sz in range(1, 6)], initial_value=1, change_submits=True, key='spin',size=(5,3),background_color="Sky Blue"),sh.Button("prioritize")],
